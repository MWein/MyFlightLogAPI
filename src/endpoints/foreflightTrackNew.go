...
func ForeflightTrackNew(w http.ResponseWriter, r *http.Request) {
	...
	database.DBConnection.QueryRow("SELECT data FROM foreflight_test WHERE flightid = $1", id[0]).Scan(&foreflightTrackBytes)
